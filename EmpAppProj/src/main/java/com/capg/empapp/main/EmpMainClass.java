...
public class EmpMainClass {
	...
	public static void main(String[] args) {
		...
		while(true)
		{
			...
			System.out.println("5.Edit Employee salary by Employee ID");
			System.out.println("6.Edit Experience by Employee ID");
			...
			case 3:
				...
				int empSalToGetEmployees= Integer.parseInt(sc.nextLine());
				int countSal=EmployeeDB.count;
				System.out.println("Count value:"+countSal);
				Employee salary[]=app.empService.getEmployeeBySalary(empSalToGetEmployees);
				System.out.println("The Employees with salary of "+empSalToGetEmployees);
				for (int i = 0; i < countSal; i++) {
					System.out.println(salary[i]);
					System.out.println(" ========================================================");
				//while(empSalToGetEmplolyees==empSalToGetEmployees)
				}
				break;
			case 4:
